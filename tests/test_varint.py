...
class TestVarInt(unittest.TestCase):
    ...
    def test_serialize_varint(self):
        ...
        with self.assertRaises(AssertionError,
                               msg="should be raised because `n` argument overflows to more than 64 bits"):
    ...
    def test_deserialize_varint(self):
        ...
        assert deserialize_varint(b("ffffffffffffffffff")) == (0xffffffffffffffff, 9)
        ...
        assert deserialize_varint(b("ff0000000001000000"), 0) == (4294967296, 9)
        assert deserialize_varint(b("ffffffffffffffffff"), 0) == (0xffffffffffffffff, 9)
        ...
        assert deserialize_varint(b("ff0000000001000000cc"), 0) == (4294967296, 9)
        assert deserialize_varint(b("ffffffffffffffffffcc"), 0) == (0xffffffffffffffff, 9)
        ...
        assert deserialize_varint(b("ccff0000000001000000"), 1) == (4294967296, 10)
        assert deserialize_varint(b("ccffffffffffffffffff"), 1) == (0xffffffffffffffff, 10)
        ...
        assert deserialize_varint(b("ccff0000000001000000cc"), 1) == (4294967296, 10)
        assert deserialize_varint(b("ccffffffffffffffffffcc"), 1) == (0xffffffffffffffff, 10)
        ...
        with self.assertRaises(AssertionError, msg="should be raised because `data` argument "
        ...
        with self.assertRaises(AssertionError, msg="should be raised because `i` argument is 0 when it "
                                                   "should be 1 thus a different value is deserialized"):
            assert deserialize_varint(b("cc00"), 0) == (0, 1)
        with self.assertRaises(AssertionError, msg="should be raised because `i` argument is 2 when "
