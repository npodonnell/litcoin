...
class TestInt32(unittest.TestCase):
    ...
    def test_validate_int32(self):
        ...
        with self.assertRaises(AssertionError, msg='should be raised because positive `n` argument overflows to more than 31 bits'):
            validate_int32(0x80000000)
        with self.assertRaises(AssertionError, msg='should be raised because negative `n` argument overflows to more than 31 bits'):
            validate_int32(-0x80000000)
    ...
    def test_serialize_int32(self):
        ...
        assert serialize_int32(-2) == b('feffffff')
